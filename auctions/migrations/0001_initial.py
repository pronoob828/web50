    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commented_listings', to='auctions.auction_listing')),
            ],
        ),
        migrations.CreateModel(
            name='bid',
            fields=[
                ...
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listings_bid_on', to='auctions.auction_listing')),
            ],
        ),
    ]
